...
// Sample product data - filtered for charms
const products = [
  {
    id: "2",
  ...
  },
  {
    id: "17",
    name: "Heart Charm",
    description: "A classic heart charm that symbolizes love and compassion.",
    price: 17.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "charms",
    featured: true,
  },
  {
    id: "18",
    name: "Moon Charm",
    description: "A crescent moon charm that adds a celestial touch to your jewelry.",
    price: 16.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "charms",
    new: true,
  },
  {
    id: "19",
    name: "Flower Charm",
    description: "A detailed flower charm that brings natural beauty to your accessories.",
    price: 18.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "charms",
  },
  {
    id: "20",
    name: "Initial Charm",
    description: "Personalize your jewelry with an initial charm of your choice.",
    price: 21.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "charms",
  },
  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-light tracking-wide">Charms</h1>
          <p className="text-muted-foreground font-light">
            Handcrafted charms that fund medical care for those in need
          </p>
        </div>
