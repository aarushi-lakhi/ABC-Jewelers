...
// Sample product data - filtered for rings
const products = [
  {
    id: "4",
    name: "Petal Ring",
  ...
  },
  {
    ...
    description: "A classic twisted band design that adds texture and interest to your jewelry collection.",
    price: 22.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "rings",
    new: true,
  },
  {
    ...
    description: "A set of three delicate rings designed to be worn together or separately.",
    price: 39.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "rings",
    featured: true,
  },
  {
    ...
    description: "A bold statement ring featuring a colorful gemstone centerpiece.",
    price: 34.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "rings",
  },
  {
    ...
    description: "A sleek, minimalist band that complements any style.",
    price: 19.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "rings",
  },
  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-light tracking-wide">Rings</h1>
          <p className="text-muted-foreground font-light">Handcrafted rings that fund medical care for those in need</p>
        </div>
