...
// Sample product data - filtered for earrings
const products = [
  {
    id: "1",
  ...
  },
  {
    ...
    description: "Delicate leaf-shaped earrings that bring a touch of nature to your style.",
    price: 27.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "earrings",
    new: true,
  },
  {
    ...
    description: "Modern geometric stud earrings with a minimalist design.",
    price: 24.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "earrings",
  },
  {
    ...
    description: "Elegant hoop earrings with delicate floral details.",
    price: 34.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "earrings",
    featured: true,
  },
  {
    ...
    description: "Playful butterfly earrings that add movement and charm to any outfit.",
    price: 29.99,
    image: "/placeholder.svg?height=300&width=300",
    category: "earrings",
  },
  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-light tracking-wide">Earrings</h1>
          <p className="text-muted-foreground font-light">
            Handcrafted earrings that fund medical care for those in need
          </p>
        </div>
